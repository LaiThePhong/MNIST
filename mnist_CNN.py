...
X_val, y_val = X_train[50000:60000,:], y_train[50000:60000] # Shape of X_val(10000,28,28), y_val(10000,)
...
#print('Dữ liệu y ban đầu ', y_train.shape)
#print('Dữ liệu y sau one-hot encoding ',Y_train.shape)
